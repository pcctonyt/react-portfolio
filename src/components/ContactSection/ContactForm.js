    ...
    <div id="form">
        <div className="form">
                <form onSumbit={handleSubmit}>
                    ...
                    <label htmlFor="inputtedEmail">Email Address:<input type="email" id="inputtedEmail" name="inputtedEmail" value={inputtedEmail} onChange={(e) => setInputtedEmail(e.target.value)} placeholder="Please enter a valid email address:" required/></label>
